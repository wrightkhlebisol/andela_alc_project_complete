...
var _students = require("./components/students.js");
...
var App = function () {
  function App(body, footer) {
    ...
    this.students = new _students2.default(body);
    this.studentsForm = new _students2.default(body);
  ...
  _createClass(App, [{
    ...
    value: function signinEvents() {
      ...
      this.signin.on("signin", function (token) {
        ...
        _this.menu.render("students");
        _this.students.render();
      });
    ...
    key: "studentsEvents",
    value: function studentsEvents() {
      var _this3 = this;

      this.students.on("error", function () {
        return alert("Student list error");
      });
      this.students.on("remove-error", function () {
        return alert("Student delete error");
      });
      this.students.on("update-error", function () {
        return alert("Student update error");
      });
      this.students.on("remove", function () {
        return _this3.students.render();
      });
      this.students.on("update", function () {
        return _this3.students.render();
      });
    }
  }, {
    key: "studentsFormEvents",
    value: function studentsFormEvents() {
      var _this4 = this;

      this.studentsForm.on("error", function () {
        return alert("Student register error");
      });
      this.studentsForm.on("submit", function () {
        _this4.menu.render("students");
        _this4.students.render();
      });
    }
  }, {
    key: "userEvents",
...
},{"./components/menu.js":4,"./components/signin.js":5,"./components/signup.js":6,"./components/students.js":7,"./components/user.js":8}],4:[function(require,module,exports){
"use strict";

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _students = require("../students.js");
...
var Menu = function (_Students) {
  _inherits(Menu, _Students);
...
},{"../students.js":9,"../templates/footer.js":10}],5:[function(require,module,exports){
"use strict";
...
var Signin = function (_Students) {
  _inherits(Signin, _Students);
...
},{"../students.js":9,"../templates/signin.js":11}],6:[function(require,module,exports){
"use strict";
...
var Signup = function (_Students) {
  _inherits(Signup, _Students);
...
},{"../students.js":9,"../templates/signup.js":12}],7:[function(require,module,exports){
"use strict";
...
var _students3 = require("../templates/students.js");
...
var Student = function (_Students) {
  _inherits(Student, _Students);
  ...
  _createClass(Student, [{
    ...
    key: "renderStudentsList",
    value: function renderStudentsList() {
      var _this2 = this;
      ...
      this.request(opts, function (err, resp, data) {
        if (err) {
          ...
          _this2.body.innerHTML = _students4.default.render(data);
          _this2.addEventListener();
        }
      });
    }
  }, {
    key: "studentsDoneCheckbox",
    value: function studentsDoneCheckbox() {
      var _this3 = this;
      ...
      for (var i = 0, max = dones.length; i < max; i++) {
        dones[i].addEventListener("click", function (e) {
          e.preventDefault();
          var id = e.target.getAttribute("data-students-id");
          var done = e.target.getAttribute("data-students-done");
          var opts = {
            method: "PUT",
            url: _this3.URL + "/students/" + id,
            headers: {
              authorization: localStorage.getItem("token"),
    ...
    key: "studentsRemoveClick",
    value: function studentsRemoveClick() {
      var _this4 = this;
...
},{"../students.js":9,"../templates/students.js":13}],8:[function(require,module,exports){
"use strict";
...
var User = function (_Students) {
  _inherits(User, _Students);
...
},{"../students.js":9,"../templates/user.js":14}],9:[function(require,module,exports){
"use strict";
...
var Students = function (_TinyEmitter) {
  _inherits(Students, _TinyEmitter);
...
},{"browser-request":1,"tiny-emitter":2}],10:[function(require,module,exports){
"use strict";

exports.render = function (path) {
  var isStudents = path === "students" ? "active" : "";
  var isStudentsForm = path === "studentsForm" ? "active" : "";
...
var renderStudents = function renderStudents(students) {
  return students.map(function (students) {
    var done = students.done ? "ios-checkmark" : "ios-circle-outline";
...
exports.render = function (students) {
